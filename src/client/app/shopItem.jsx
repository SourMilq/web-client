        ...
        render: function() {
                ...
                return (
                        <li className={classes}>
                                <div className="row">                                        
                                        <div className="item-name col-xs-3 col-xl-3 col-md-3 pull-left"> {this.props.item} </div>
                                        <div className="item-name-2 col-xs-6 col-xl-6 col-md-6 pull-center"> {this.props.item} </div>
